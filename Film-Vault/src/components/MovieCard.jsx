...
const MovieCard = ({ movie }) => {
  ...
  return (
    <div className='group relative m-4 h-[40vh] w-[30vw] md:h-[60vh] md:w-[20vw] rounded-lg overflow-hidden hover:scale-105 hover:cursor-pointer transition-transform duration-300 ease-in-out'>
      {poster ? (
        <img
          src={poster}
          alt={title}
      ...
      {/* hover box showing full movie name */}
